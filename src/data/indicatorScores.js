...
// Get dispute period breakdown for a province
export function getDisputeBreakdown(provinceId) {
  return DISPUTE_BREAKDOWN[provinceId] || null;
}

// Get order of possession breakdown for a province
export function getOrderBreakdown(provinceId) {
  return ORDER_BREAKDOWN[provinceId] || null;
}
